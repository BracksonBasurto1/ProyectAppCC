...
(function($) {
    $(document).ready(function(){
        ...
        var loadScript = function() {
            /*******************************************
            * Fix by Christopher Díaz, 29 ago 2016
            * Accept API KEY from attribute data-key
            ********************************************/
            if(jQuery('.gk-map').attr('data-key') !== undefined && jQuery('.gk-map').attr('data-key') != ''){
                api_key = '&key=' + jQuery('.gk-map').attr('data-key');
            }
            else{
                api_key = '';
            }
            /******************************/
            $.getScript("https://maps.googleapis.com/maps/api/js?v=3.exp&callback=gkMapInitialize" + api_key)
